...
pickle.dump(words, open('../../chatbot-se05/app/words.pkl', 'wb'))
pickle.dump(classes, open('../../chatbot-se05/app/classes.pkl', 'wb'))
pickle.dump(documents, open('../../chatbot-se05/app/documents.pkl', 'wb'))
pickle.dump(ignore_words, open('../../chatbot-se05/app/ignore_words.pkl', 'wb'))
